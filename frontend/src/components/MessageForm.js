      ...
      <div className='messages-output'>
        ...
        {user && privateMemberMsg?._id && (
          <>
           ...
           <div> Your conversation with {privateMemberMsg.name} <img src={privateMemberMsg.picture} className="conversation-profile-pic" />
         </div>
        </div>
       </>
                )}
        
        {!user && <div className='alert alert-danger'>pleace Login</div>}
        {user &&
